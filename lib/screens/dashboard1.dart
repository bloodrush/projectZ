...
final List<List<CircularStackEntry>> _quarterlyProfitPieData = [
  ...
  <CircularStackEntry>[
    new CircularStackEntry(
      <CircularSegmentEntry>[
        new CircularSegmentEntry(1800.0, Colors.blueGrey,
            rankKey: 'Q1'),
        new CircularSegmentEntry(1800.0, Colors.deepPurple[800], rankKey: 'Q2'),
        new CircularSegmentEntry(4000.0, Colors.purpleAccent[700], rankKey: 'Q3'),
      ],
      rankKey: 'Quarterly Profits',
    ),
  ],
                ...
                children: <Widget>[
                  Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Center(
                              child:( Text('Quarterly amounts for Q1 2019', style: TextStyle(fontSize: 20.0),))
                          ),
                          Center(
                ...
                children: <Widget>[
                  Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Center(
                              child:( Text('3-month deliverables for Q1 2019', style: TextStyle(fontSize: 20.0),))
                          ),
                          Center(
                            child: new AnimatedCircularChart(
                              edgeStyle: SegmentEdgeStyle.round,
                  ...
                  Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Center(
                              child:( Text('3-month deliverables for Q2 2019', style: TextStyle(fontSize: 20.0),))
                          ),
                          Center(
                            child: new AnimatedCircularChart(
                              edgeStyle: SegmentEdgeStyle.round,
